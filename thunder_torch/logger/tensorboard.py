...
class TensorBoardLoggerAdjusted(LightningLoggerBase):
    r"""
    ...
    Example:
        ...
        >>> from thunder_torch.logger.tensorboard import TensorBoardLoggerAdjusted
        >>> logger = TensorBoardLoggerAdjusted("tb_logs", name="my_model")
    ...
    def log_hyperparams(self, params: Union[Dict[str, Any], Namespace],
        ...
        # original code changed at this point to make it possible to work with pytorch 1.2.0
