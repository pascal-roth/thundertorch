stfs\_pytoolbox.ML_Utils package
====================================


.. automodule:: stfs_pytoolbox.ML_Utils
   :members:
   :undoc-members:
...
1. The data samples to train and test the network included in a
   `DataLoader <./ML_utils/getting_started/DataLoader.ipynb>`__
2. The `Model <./ML_utils/getting_started/Models.ipynb>`__ itself
3. The `Trainer <./ML_utils/getting_started/Trainer.ipynb>`__ that takes the
   `Model <./ML_utils/getting_started/Models.ipynb>`__ and trains, as well as test it with the
   data included in the `DataLoader <./ML_utils/getting_started/DataLoader.ipynb>`__
...
-  by a code implementation (`Working Example:
   Code <./ML_utils/working_examples/working_example_code.ipynb>`__)
...
-  by using the yaml interface
   ...
   -  for a single model: (`Working Example:
      Yaml <./ML_utils/working_examples/working_example_yaml.ipynb>`__)
   -  for an arbriary number of models as a queue of parallel processes
      which is explained separately
      `here <./ML_utils/getting_started/MultiModelTraining.ipynb>`__
